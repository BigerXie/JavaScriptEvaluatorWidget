...
d=this.strToJson(c.getProperty("_InputParametersDataShape")),f="var result;";for(e in d)f+="var "+e+" = thisWidget.getProperty('"+e+"');";var e="try {"+f+'function triggerCustomEvent() {try {thisWidget.jqElement.triggerHandler("CustomEvent");} catch (exception) {console.log(exception);}};'+a+"} catch (exception) {console.log(exception);}";b&&(console.log("JavaScriptEvaluator - evaluate -> Start"),console.log("JavaScriptEvaluator - evaluate -> variableDefinitions = "+f),console.log("JavaScriptEvaluator - evaluate -> code = "+
